...
const PinchingHandGesture = new GestureDescription('pinching-hand') //🤏
...
// Italian Hand
//------------------------------------------------------------------------------
PinchingHandGesture.addCurl(Finger.Index, FingerCurl.HalfCurl, 0.8)
PinchingHandGesture.addCurl(Finger.Index, FingerCurl.FullCurl, 0.5)

PinchingHandGesture.addCurl(Finger.Thumb, FingerCurl.NoCurl, 1.0)
PinchingHandGesture.addCurl(Finger.Thumb, FingerCurl.HalfCurl, 0.4)

PinchingHandGesture.addCurl(Finger.Middle, FingerCurl.HalfCurl, 1.0)
PinchingHandGesture.addCurl(Finger.Middle, FingerCurl.FullCurl, 0.9)

PinchingHandGesture.addCurl(Finger.Ring, FingerCurl.HalfCurl, 1.0)
PinchingHandGesture.addCurl(Finger.Ring, FingerCurl.FullCurl, 0.9)

PinchingHandGesture.addCurl(Finger.Pinky, FingerCurl.HalfCurl, 1.0)
PinchingHandGesture.addCurl(Finger.Pinky, FingerCurl.FullCurl, 0.9)
